...
- [x] **5.3.1** LOAO завершён для всех 3 MV4 архитектур — все FAIL
  - BiLSTM+Att: Mean=0.545 | BiLSTM: Mean=0.582 | TCN: Mean=0.280
  - MV4 не обобщается по снарядам (Ribbon системно провальный: 0.030–0.234)
...
- [x] **5.3.3** Результаты зафиксированы в чеклисте и графиках
...
- [x] **5.4.D.1** Обновить `docs/thesis_research_notes.md` ← следующий шаг
- [x] **5.4.D.2** Коммит: "Phase 5: MobileNetV4 backbone evaluation"
...
|---------|--------------------|---------------|------------|-----------------|------------|---------|
| mAP@0.5 (valid, mean) | 0.830±0.031 | 0.827±0.031 | 0.763±0.098 | 0.854±0.042 | 0.859±0.041 | 0.652±0.056 |
| mAP@0.5 (test, seed=42) | 0.788 | 0.791 | 0.900 | 0.873 | 0.860 | 0.802 |
| LOAO Mean | 0.739 ❌ | 0.672 ❌ | 0.590 ❌ | 0.545 ❌ | 0.582 ❌ | 0.280 ❌ |
| LOAO Ribbon | 0.800 | 0.536 ❌ | 0.713 | 0.170 ❌ | 0.234 ❌ | 0.030 ❌ |
...
- [x] 3 seeds обучены, метрики зафиксированы (все 3 архитектуры × 3 seeds)
- [x] LOAO завершён (все 3 архитектуры — все FAIL)
- [x] FPS измерен (e2e, все 11 моделей включая MV4)
- [x] Результаты добавлены в графики (fig17–19) и чеклист
- [ ] thesis_research_notes.md обновлён
