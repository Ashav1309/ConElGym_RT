...
MODELS_SEED42 = [
    ...
    ("mv3_bilstm",              0.765, 0.672, 0.617, 0.658, 0.794, 0.394, 99.9,    9.7,    0.692),
    ("mv3_bilstm_attn",         0.645, 0.644, 0.516, 0.691, 0.746, 0.359, 102.7,   10.6,   0.541),
    ("mv3_tcn",                 0.690, 0.552, 0.338, 0.568, 0.667, 0.609, 529.6,   7.5,    0.554),
    ("eff_b0_mlp",              0.182, 0.091, 0.091, 0.545, 0.095, 0.943, 1309.1,  16.5,   0.091),
...
# Multi-seed test mAP и BE (seed=42/123/2024, opt-конфиг)
# Для mv3 моделей seed42=base; seed123/2024=opt
MULTI_SEED = {
    ...
    "mv3_bilstm":         {"map": [0.672, 0.763, 0.769], "be": [0.394, 0.420, 0.310]},
    "mv3_bilstm_attn":    {"map": [0.644, 0.749, 0.737], "be": [0.359, 0.320, 0.350]},
    "mv3_tcn":            {"map": [0.552, 0.470, 0.439], "be": [0.609, 0.520, 0.600]},
    "eff_b0_mlp":         {"map": [0.091, 0.149, 0.146], "be": [0.943, 0.910, 0.890]},
